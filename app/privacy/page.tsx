...
export default function PrivacyNotice() {
  return <LegalPage title="Privacy notice" intro="How application and testimonial information is handled.">
    ...
    <LegalSection title="Private delivery"><p>Submissions are collected by Netlify Forms, the website host&apos;s built-in form service, and stored in a private dashboard that only nqcraig can access. Netlify then sends an email notification to a private inbox controlled by nqcraig. Submissions are never displayed on the website.</p></LegalSection>
