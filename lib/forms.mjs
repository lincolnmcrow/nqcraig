...
export const applicationSchema = z.object({
  ...
  acceptedRisk: z.literal(true, { error: "Acknowledge the trading risk." }),
  acceptedPrivacy: z.literal(true, { error: "Accept the privacy notice." }),
});
...
export const testimonialSchema = z.object({
  ...
  honestExperience: z.literal(true, { error: "Confirm this is your honest experience." }),
  allowEditing: z.boolean(),
  allowName: z.boolean(),
  allowTestimonial: z.literal(true, { error: "Permission is required to review this submission." }),
});
